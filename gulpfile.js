...
gulp.task('js-minify', function () {
  return gulp.src(['src/assets/js/**/*.js', 'src/components/**/*.js'])
    .pipe(concat('main.js'))
    .pipe(uglify({
      compress: {
        drop_console: true
...
gulp.task('watch', function () {
  ...
  gulp.watch(['src/components/**/*.js', 'src/assets/js/**/*.js'], gulp.series('js-minify'));
...
// Development
gulp.task('dev', gulp.parallel('clean:assets', 'fractal:start', 'js-minify', 'css-minify', 'watch', 'sass'));

// Build to share
gulp.task('build', gulp.series('image-minify', 'js-minify', 'css-minify', 'fractal:build'));
